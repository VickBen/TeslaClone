  ...
  return (
    <div className="container">
      ...
      <div className="rightMenu">
        ...
        <div style={{transform: burgerStatus? 'translateX(0)':'translateX(100%)'}} onClick={()=>setBurgerStatus(false)} className="menuIcon">
         
          <MenuIcon />
          
        </div>
      </div>
      <div style={{transform: burgerStatus? 'translateX(100%)':'translateX(0)'}} className="BurgerNav" >
        {/* show= {burgerStatus} */}
         <div onClick={()=>setBurgerStatus(true)} className="closeWrapper">
        <CloseIcon/>
        </div>
